 ...
 */
public class CycleWheelViewbig extends ListView {
    public static final String TAG = CycleWheelViewbig.class.getSimpleName();
    ...
    public CycleWheelViewbig(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public CycleWheelViewbig(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CycleWheelViewbig(Context context) {
        super(context);
    }
    private void init() {
    ...
    public void setSelection(final int position) {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                CycleWheelViewbig.super.setSelection(getPosition(position));
            }
        });
    }
    ...
    public void selection(final int position){
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                CycleWheelViewbig.this.setSelection(position);
            }
        });
    }
