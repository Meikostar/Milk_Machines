...
//                }
                ...
                byte[] ssid =ByteUtil.getBytesByString(tvName.getText().toString());
                byte[] password = ByteUtil.getBytesByString(etWifi.getText().toString());
                byte [] bssid = EspNetUtil.parseBssid2bytes(WifiUtils.shareInstance().getBSSID());
...
//                                    Log.i(TAG, "progress dialog cancel button canceled");
                ...
                if (firstResult.isSuc()) {
                    ...
                    for (IEsptouchResult resultInList : result) {
                        sb.append("Esptouch success, bssid = ")
                                ...
                                .append("\n");
                        count++;
                        reconnectLanSvr(resultInList.getBssid(),"12345678");
    ...
    private static void reconnectLanSvr(String ip,  String pw) {
        ConfigUtils.setAddress(ip, 5000);
